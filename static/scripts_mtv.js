...
socket.on('newstatus', function(msg) {
    ...
    //Pickup Rate
    document.getElementById("patrick_pickup").innerHTML = msg.taken_list[5];
    document.getElementById("matin_pickup").innerHTML = msg.taken_list[6];
    document.getElementById("jim_pickup").innerHTML = msg.taken_list[7];
    ...
    notAnsweredList(msg.not_answered_list_mtv);
    console.log("Not answered ticket list " + msg.not_answered_list_mtv + ", Var type: " + typeof(msg.not_answered_list));
});
