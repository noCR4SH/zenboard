...
socket.on('newstatus', function(msg) {
    ...
    //Pickup Rate
    document.getElementById("binu_pickup").innerHTML = msg.taken_list[8];
    document.getElementById("harry_pickup").innerHTML = msg.taken_list[9];
    document.getElementById("rupesh_pickup").innerHTML = msg.taken_list[10];
    document.getElementById("yash_pickup").innerHTML = msg.taken_list[11];
    document.getElementById("manoj_pickup").innerHTML = msg.taken_list[12];
    document.getElementById("hardik_pickup").innerHTML = msg.taken_list[13];
    document.getElementById("arshad_pickup").innerHTML = msg.taken_list[14];
    document.getElementById("prakash_pickup").innerHTML = msg.taken_list[15];
    document.getElementById("philip_pickup").innerHTML = msg.taken_list[16];
    document.getElementById("sooraj_pickup").innerHTML = msg.taken_list[17];
